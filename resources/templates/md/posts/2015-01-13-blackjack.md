...
And then, for comparison, the **original BASIC version** (ok, this one is not a fair comparison since it _does_ allow splitting and insurance, but still).
...
Yup, that is _long_. If you scrolled all the way down here, a bit of gameplay:
